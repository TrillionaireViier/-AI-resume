...
const PhotoUploadField = ({ label, onPhotoSelect }) => {
  ...
  return (
    <div className="mb-5 md:col-span-2">
      <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1.5 ml-1">{label}</label>
      <label className="flex items-center justify-center w-full px-4 py-2.5 bg-slate-800/30 border border-slate-700/50 border-dashed rounded-lg cursor-pointer hover:bg-slate-700/40 hover:border-indigo-500/50 transition-all text-sm text-indigo-300 font-medium group">
        <span className="flex items-center gap-2">
           <svg className="w-4 h-4 text-indigo-400 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path></svg>
           Upload Photo
        </span>
        <input 
          type="file" 
